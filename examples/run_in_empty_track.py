...
def main():
    ...
    planner = PurePursuitPlanner(track=track, wb=0.17145 + 0.15875) # TODO: remove this

    # rendering callbacks
    env.unwrapped.add_render_callback(track.raceline.render_waypoints) # TODO: remove this
